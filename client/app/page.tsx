    ...
    try {
      ...
      await axios.post(
        `${NEXT_PUBLIC_API_BASE_URL}/recipes/save`,
        {
          ...
          ingredients: recipe.ingredients || [], // Keep it empty if not provided
          instructions: recipe.instructions || "", // Default to an empty string
        },
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {recipes.map((recipe) => (
            <RecipeCard
              key={recipe.id} // Change from `_id` to `id`
              recipe={{
                _id: recipe.id, // Map `id` to `_id`
                title: recipe.title,
                imageUrl: recipe.image, // Ensure correct image property
                ingredients: [], // API doesn't provide ingredients, set as empty array
                instructions: "", // API doesn't provide instructions, set as empty string
              }}
